...
import { Search, PlusSquare, Box, LogIn, Moon, Sun, BookOpen } from 'lucide-react';
        ...
        <nav className="flex items-center gap-2">
          ...
          <button
            ...
            className={`p-1 text-xs border ${
              isDark ? 'border-[#1e3a8a] text-[#60a5fa]' : 'border-[#001255] text-[#001255]'
            }`}
          ...
          >
            ...
            <span
              className={`text-xs px-1.5 py-0.5 border ${
                isDark ? 'border-[#1e3a8a] text-[#93c5fd]' : 'border-[#001255] text-[#001255]'
              }`}
            >
              {myBoxCount}
            </span>
