      ...
      >
        <div className="flex items-center justify-between border-b pb-4 mb-6 border-current">
          <div className="flex items-center gap-2">
            ...
            {type === 'privacy' && <Shield className="w-5 h-5 text-green-600" />}
          ...
          <div className="space-y-6 text-xs md:text-sm">
            <div>
              ...
              <div className="opacity-90 leading-relaxed">
                A: Because you are hungry right now. You do not need to know what the autumn leaves smelled like in 2004 to brown 1 lb of ground beef.
              </div>
            </div>
            ...
            <div>
              ...
              <div className="opacity-90 leading-relaxed">
                A: No. This is Card Box, not the CERN laboratory. If a dish takes 35 ingredients, rethink your life choices.
              </div>
            </div>
            ...
            <div>
              ...
              <div className="opacity-90 leading-relaxed">
                A: Dishes with 4 or fewer ingredients, or under 15 minutes of mechanical effort. Maximum flavor, minimum cognitive load.
              </div>
            </div>
            ...
            <div>
              ...
              <div className="opacity-90 leading-relaxed">
                A: Tell your cat directly. Your cat will care approximately as much as we do.
              </div>
            </div>
          </div>
        )}
        ...
        {type === 'privacy' && (
          <div className="space-y-4 text-xs md:text-sm leading-relaxed">
            <p>
              <strong>1. NO TRACKING SCRIPTS:</strong> We do not track your mouse, your heartbeat, or what supermarket you visit.
            </p>
            <p>
              <strong>2. LOCAL STORAGE FIRST:</strong> Your personal card box and custom recipe donations are stored in your browser's persistent storage.
            </p>
            <p>
              <strong>3. ZERO COOKIES FOR ADS:</strong> We have no banner advertisements, no pop-up newsletter modals, and no corporate sponsor overrides.
            </p>
          </div>
        )}
        ...
        {type === 'terms' && (
          <div className="space-y-4 text-xs md:text-sm leading-relaxed">
            <p>
              <strong>CLAUSE 1:</strong> You agree not to upload blog essays disguised as recipes.
            </p>
            <p>
              <strong>CLAUSE 2:</strong> All uploaded recipes must have accurate cook times. Lying that caramelizing onions takes "5 minutes" is a violation of international kitchen law.
            </p>
            <p>
